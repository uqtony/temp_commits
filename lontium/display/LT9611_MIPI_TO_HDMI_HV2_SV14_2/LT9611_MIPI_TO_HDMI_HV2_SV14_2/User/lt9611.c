...
//	HDMI_WriteI2C_Byte(0x50,0x10); //signal port switch: portA:10;  portB:14
	
	HDMI_WriteI2C_Byte(0xff,0x83); 
	HDMI_WriteI2C_Byte(0x00,lanes); 
//	HDMI_WriteI2C_Byte(0x03,0x00); //signal port switch: portA:00;  portB:40
	HDMI_WriteI2C_Byte(0x02,0x10); //settle
	HDMI_WriteI2C_Byte(0x06,0x10); //settle
...
//		HDMI_WriteI2C_Byte(0x44,0x30);//AVI_PB1///////////////////////////////////YUV422
...
/////////////////////////////////////////////////////测试
//  HDMI_WriteI2C_Byte(0xff,0x81);
//	HDMI_WriteI2C_Byte(0x39,0x80);
//	HDMI_WriteI2C_Byte(0x3A,0xAA);
//	HDMI_WriteI2C_Byte(0x3B,0x80);
//	HDMI_WriteI2C_Byte(0x3C,0xAA);
//	HDMI_WriteI2C_Byte(0x3D,0x80);
//	HDMI_WriteI2C_Byte(0x3E,0xAA);
////////////////////////////////////////////////////
  LT9611_Audio_Init();
//	LT9611_HDCP_Init();
  ...
  //lt9611_cec_msg_write_demo();
	...
	while(1)
	{
		...
		if(lt9611.hdcp_encryption == hdcp_enable)
	  {
			...
			{
				HDMI_WriteI2C_Byte(0xff,0x85);
		    if(((HDMI_ReadI2C_Byte(0x44)&0x04)==0x04)&&((HDMI_ReadI2C_Byte(0x44)&0x02)==0x00))
		    {
					LT9611_HDCP_Disable();
			    LT9611_HDCP_Enable();
				}
