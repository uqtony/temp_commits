...
void Mod_ChipID_Read(void)
{
    ...
    LTLog(LOG_INFO,"LT9211C Chip ID: 0x%02bx 0x%02bx 0x%02bx", HDMI_ReadI2C_Byte(0x00),HDMI_ReadI2C_Byte(0x01),HDMI_ReadI2C_Byte(0x02));
...
void Mod_SystemRx_SetState(u8 ucState)
{
    ...
    {   
        ...
        LTLog(LOG_DEBUG, "RxState = 0x%02bx", ucState);
