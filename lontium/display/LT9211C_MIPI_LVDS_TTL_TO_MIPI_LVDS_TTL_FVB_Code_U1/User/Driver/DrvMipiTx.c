...
*/
u8 code szTap0Setting[2] = {0x14, 0x14};  //250ohm
u8 code szTap1Setting[2] = {0x08, 0x08};  //100ohm
//========================================================================
...
void Drv_MipiTx_PllSet(IN StructMipiTx* pstMipiTx)
{
    ...
    LTLog(LOG_DEBUG, "ulMipiDataRate:%ld, ulHalfPixClk:%ld, ulMpiTXPhyClk:%ld, ucBpp:%bd, ucTxPortNum:0x%02bx, ucTxLaneNum:0x%02bx",
    ...
    LTLog(LOG_DEBUG,"ucSericlkDiv N1:0x%02bx, ucDivSet M2:0x%02bx",ucSericlkDiv, ucDivSet);
}
//========================================================================
...
void Drv_MipiTx_PhyTimingParaSet(INOUT StructMipiTx* pstMipiTx, INOUT StructMipiTxDPhy* pstMipiTxDPhy)
{
    ...
    LTLog(LOG_DEBUG, "ck_post (0xD4A9) = 0x%02bx", pstMipiTxDPhy->ucClkPost);
    LTLog(LOG_DEBUG, "ck_zero (0xD4A7) = 0x%02bx", pstMipiTxDPhy->ucClkZero);
    LTLog(LOG_DEBUG, "hs_lpx  (0xD4A4) = 0x%02bx", pstMipiTxDPhy->ucHsLpx);
    LTLog(LOG_DEBUG, "hs_prep (0xD4A5) = 0x%02bx", pstMipiTxDPhy->ucHsPrep);
    LTLog(LOG_DEBUG, "hs_trail(0xD4A6) = 0x%02bx", pstMipiTxDPhy->ucHsTrail);
    LTLog(LOG_DEBUG, "hs_rqst (0xD48A) = 0x%02bx", pstMipiTxDPhy->ucHsRqStPre);
}
