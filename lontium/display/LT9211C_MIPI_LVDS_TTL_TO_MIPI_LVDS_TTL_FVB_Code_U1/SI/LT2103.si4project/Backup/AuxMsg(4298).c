...
void Chip_Aux_SendData(u8 ucLenth)
{
    BKD9_2B_REG = AUXACK;
...
//Info  :N/A
//============================================
void Chip_Aux_EdidRead(u8 ucLenth)
{
    BKD9_2B_REG = AUXACK;
    for(g_stAuxStatus.ucLoopAux = 0; g_stAuxStatus.ucLoopAux < ucLenth;g_stAuxStatus.ucLoopAux++)
    {
...
//Info  :N/A
//===========================================
void Chip_Aux_LastEdidRead(u8 ucLenth)
{
    BKD9_2B_REG = AUXACK;
...
//Info  :N/A
//===========================================
void Chip_Aux_SendZeroData(u8 ucLenth)
{
    BKD9_2B_REG = AUXACK;
    for(g_stAuxStatus.ucLoopAux = 0; g_stAuxStatus.ucLoopAux < ucLenth;g_stAuxStatus.ucLoopAux++)   //i2c last read
    {
...
void CHIP_Interrupt_AuxTask(void)
{
    ...
    switch(g_stAuxStatus.ucRxCmd)
	{
        ...
        case CMD_DPCDR:  //0x90; Native Read
                ...
                Chip_Aux_SendData(g_stAuxStatus.ucRxLength);
                break;
        case CMD_I2CW:  //0x40;
        ...
        case CMD_I2CR:  //0x50; MOT=1,I2C-R //address only or address length????
                ...
                {
                    Chip_Aux_EdidRead(g_stAuxStatus.ucRxLength);
                }
                ...
                {
                    Chip_Aux_SendZeroData(g_stAuxStatus.ucRxLength);
                }
                break;
        case CMD_I2CS:   //0x10;
                if((g_stAuxStatus.szRxAddress[2] == 0x50)&&(g_stAuxStatus.ucRxCounter == 0x04))//EDID address
                {
                    Chip_Aux_LastEdidRead(g_stAuxStatus.ucRxLength);
